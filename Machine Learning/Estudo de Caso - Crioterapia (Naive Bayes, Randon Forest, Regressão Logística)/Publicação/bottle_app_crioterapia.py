...
@get('/form/')
def index():
     #Definição de valores iniciais para as expressões nome, classificação e probabilidade
     return template('/home/juliomonteiro/mysite/formulario-crioterapia.html', nome = "-", classificacao = "-", probabilidade = "-")
...
def index_resposta():
    ...
    modelo_NB = joblib.load('/home/juliomonteiro/mysite/modelo_crioterapia_MNB.pkl')
    ...
    return template('/home/juliomonteiro/mysite/formulario-crioterapia.html', nome = nome, classificacao = classificacao, probabilidade = probabilidade)
